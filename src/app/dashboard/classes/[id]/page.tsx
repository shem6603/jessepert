...
export default function ClassDetailsPage() {
  ...
  const [newStudentPathway, setNewStudentPathway] = useState("");
    ...
    async function loadClassData() {
      ...
      try {
        ...
        if (classSnap.exists()) {
          ...
          // Security check: Only load if it belongs to current user
  ...
  const handleAddStudent = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const studentDocRef = await addDoc(collection(db, "students"), {
        ...
        pathway: newStudentPathway.trim(),
          ...
          <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl">
            ...
            <form onSubmit={handleAddStudent} className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="studentName" className="block text-sm font-bold text-navy mb-1.5">Full Name <span className="text-red-500">*</span></label>
                  <input
                    id="studentName"
                    type="text"
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Pathway 1, STEM, etc."
                    className="w-full rounded-xl border border-dark-teal/20 bg-white px-4 py-2.5 text-navy outline-none focus:border-sky-blue focus:ring-2 focus:ring-sky-blue/20 transition-all font-medium"
                  />
